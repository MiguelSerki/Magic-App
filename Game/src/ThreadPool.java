...
public class ThreadPool extends ThreadGroup {
	...
	/**
	 * Closes this ThreadPool and returns immediately. All threads are stopped, and
	 * any waiting tasks are not executed. Once a ThreadPool is closed, no more
	 * tasks can be run on this ThreadPool.
	 */
